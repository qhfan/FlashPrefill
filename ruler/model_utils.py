...
class SelfdefinedModel(LLM):
    def __init__(
        ...
        **kwargs,
        ...
        # self.model = model_dict[kwargs['self_defined_model']].from_pretrained(
        #     model_name,
        #     config=config,
...
def load_LLM(args):
    ...
    if "gpt" in args.model_name_or_path:
        ...
        kwargs['seed'] = args.seed
    elif args.self_defined_model is not None:
        model_cls = SelfdefinedModel
        kwargs['seed'] = args.seed
        kwargs['self_defined_model'] = args.self_defined_model
